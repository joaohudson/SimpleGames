...
public class JanelaPrincipal extends JFrame {
    ...
    {
        //indica movimento válido(true) ou inválido(false):
        boolean movimento;
        ...
        else 
        {
            ...
            //move a peça:
            movimento = jogo.mover(casaClicadaOrigem.getPosicaoX(), casaClicadaOrigem.getPosicaoY(),
                        casaClicadaDestino.getPosicaoX(), casaClicadaDestino.getPosicaoY());
            casaClicadaOrigem.atenuar();
            primeiroClique = true;
            //informa quando o movimento foi inválido:
            if(!movimento)
            {
            ...
            if(jogo.getFimDeJogo())
            {
                ...
                printJogadorVencedor();
            }
        }
    }
    
    /**
     * Informa qual jogador começa.
     */
    private void printJogadorInicial()
    {
        //jogador que começa jogando:
        Jogador jogadorInicial = jogo.getJogadorAtual();
        //nome do jogador que começa jogando:
        String nomeJogador = jogadorInicial.getNome();
        //informa o jogador inicial:
        JOptionPane.showMessageDialog(this, nomeJogador + " Começa.");     
    }
    
    /**
     * Informa o qual foi o jogador vencedor.
     */
    private void printJogadorVencedor()
    {
        ...
        JOptionPane.showMessageDialog(this, "Vitória do: " + nomeDoVencedor + "!");
    }
    ...
    public JanelaPrincipal() {
        ...
        menuNovo.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                criarNovoJogo();//cria um novo jogo.
                printJogadorInicial();//informa que começa o jogo.
            }
        });
    ...
    private void criarNovoJogo() {
        ...
        atualizar();//atualiza o tabuleiro.
    }
